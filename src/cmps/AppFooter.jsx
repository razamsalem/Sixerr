            ...
            <section className="app-footer with-border-top flex full">
                ...
                <div className="right flex">
                    <ul className="social flex">
                        <li className='fa-brands fa-tiktok'></li>
